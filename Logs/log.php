...
<a href="../listings">Back to Listings</a> <a href="../index">Back to Index</a>
	<?php
		...
		echo "<div id='paged_container'><h2>Paged Logs</h2>
		<p itemprop='description'>The following logs are generated in php with minimal JavaScript.</p>
		<ol>";
		for ($i = 0 ; $i < sizeof($sorted_files); $i++){
			echo "<li><strong><a href ='http://bans.verniy.xyz/pages?file=" . ($i+1) . "'>4chan Bans, Log Page " . ($i+1) . "</a></strong></li>";
		}
		echo "</ol></div>";
